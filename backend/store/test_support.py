...
def make_order(user):
    ...
    return Order.objects.create(
        ...
        subtotal=1000,
        total=1000,
        estimated_delivery_start=today + timedelta(days=3),
        estimated_delivery_end=today + timedelta(days=6),
    )
...
class SupportTicketCustomerTests(APITestCase):
    ...
    def test_create_ticket_creates_ticket_and_first_message(self):
        ...
        self.assertEqual(
            ...
            "It has been 10 days and I have not received my order.",
        )
    ...
    def test_ticket_detail_owner_can_view(self):
        ...
        response = self.client.get(
            f"/api/v1/support/tickets/{created['ticket_id']}/"
        )
    ...
    def test_send_followup_message(self):
        ...
        response = self.client.post(
            f"/api/v1/support/tickets/{created['ticket_id']}/messages/",
            {
                "message": "Any update?",
            },
            format="json",
    ...
    def test_cannot_message_closed_ticket(self):
        ...
        self.client.post(
            f"/api/v1/support/tickets/{created['ticket_id']}/close/"
        )
...
class SupportTicketAdminTests(APITestCase):
    def setUp(self):
        # Support dashboard permission allows superusers or
        # members of the "Support Staff" group.
        ...
        self.alice_ticket = self.client.post(
            "/api/v1/support/tickets/",
            {
        ...
        self.bob_ticket = self.client.post(
            "/api/v1/support/tickets/",
            {
                "category": "product_issue",
                "subject": "Item arrived damaged",
                "description": "The necklace clasp is broken.",
                "priority": "medium",
            },
            format="json",
        ).data
    ...
    def test_admin_sees_all_tickets(self):
        ...
        # Admin ticket list is paginated.
        self.assertEqual(
            response.data["count"],
            2,
        )
        ...
        self.assertIn(
            response.data["results"][0]["user"]["email"],
            (
                "alice@example.com",
                "bob@example.com",
            ),
    ...
    def test_admin_can_search_by_subject(self):
        ...
        response = self.client.get(
            "/api/v1/admin/support/tickets/?search=damaged"
        )
        ...
        self.assertEqual(
            response.data["results"][0]["ticket_id"],
            self.bob_ticket["ticket_id"],
        )
    ...
    def test_admin_can_search_by_customer_email(self):
        ...
        response = self.client.get(
            "/api/v1/admin/support/tickets/?search=alice@example.com"
        )
    ...
    def test_admin_can_filter_by_priority(self):
        ...
        response = self.client.get(
            "/api/v1/admin/support/tickets/?priority=high"
        )
    ...
    def test_admin_can_view_any_ticket_detail(self):
        ...
        response = self.client.get(
            f"/api/v1/admin/support/tickets/{self.bob_ticket['ticket_id']}/"
        )
    ...
    def test_admin_can_reply(self):
        ...
        response = self.client.post(
            f"/api/v1/admin/support/tickets/{self.alice_ticket['ticket_id']}/messages/",
            {
        ...
        self.assertTrue(
            response.data["is_admin_reply"]
        )

        # Replying nudges an open ticket to in_progress.
        ticket = SupportTicket.objects.get(
            ticket_id=self.alice_ticket["ticket_id"]
        )
    ...
    def test_customer_sees_admin_reply(self):
        ...
        response = self.client.get(
            f"/api/v1/support/tickets/{self.alice_ticket['ticket_id']}/"
        )
    ...
    def test_admin_can_update_status(self):
        ...
        response = self.client.patch(
            f"/api/v1/admin/support/tickets/{self.alice_ticket['ticket_id']}/",
            {
                "status": "resolved",
            },
            format="json",
    ...
    def test_full_ticket_lifecycle(self):
        ...
        create_response = self.client.post(
            "/api/v1/support/tickets/",
            {
                ...
                "description": "Tracking hasn't moved in 5 days.",
                "priority": "medium",
            },
            format="json",
        )
        ...
        self.assertEqual(
            admin_list.data["count"],
            1,
        )
        self.assertEqual(
            len(admin_list.data["results"]),
            1,
        )
        ...
        reply = self.client.post(
            ...
            {
                "message": "Checking with the courier now.",
            },
            format="json",
        )
        ...
        self.assertTrue(
            detail.data["messages"][-1]["is_admin_reply"]
        )
